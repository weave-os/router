...
| [HMM_GO_SELECTION.md](HMM_GO_SELECTION.md) | Target architecture, flag ladder, and rollback story for moving HMM roster ownership and deterministic arm selection into Go. |
