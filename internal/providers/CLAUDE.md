...
- `openaicompat/` is the generic OpenAI Chat Completions adapter, used today for OpenRouter (`https://openrouter.ai/api/v1`), TrustedRouter (`https://api.trustedrouter.com/v1`) + Fireworks (`https://api.fireworks.ai/inference/v1`).
