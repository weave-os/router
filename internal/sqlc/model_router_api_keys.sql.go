...
func (q *Queries) GetActiveModelRouterAPIKeyWithInstallationByHash(ctx context.Context, keyHash string) (GetActiveModelRouterAPIKeyWithInstallationByHashRow, error) {
	...
	err := row.Scan(
		...
		&i.RouterModelRouterInstallation.TrialCaptureEnabled,
		&i.RouterModelRouterInstallation.TrialEnrollmentID,
		&i.RouterModelRouterInstallation.TrialShadowSampleRate,
		&i.RouterModelRouterInstallation.TrialShadowDailyCeilingUsdMicros,
	)
	return i, err
}
...
SELECT id, installation_id, external_id, name, key_prefix, key_hash, key_suffix, last_used_at, created_at, deleted_at, created_by, spend_cap_usd_micros, spent_usd_micros, scope, credential_subject_id
FROM router.model_router_api_keys
