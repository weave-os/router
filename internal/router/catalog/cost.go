...
// SignedUSDToMicros is USDToMicros without the negative clamp. Planner EV
// terms are signed (stay turns are often negative); NaN/Inf still collapse
// to 0 so a non-finite value cannot persist as BIGINT garbage.
